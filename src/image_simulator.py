...
class ImageSimulator:
    ...
    def simulate_test_pattern(
        self, pattern_name: str, size: Tuple[int, int] = (512, 512), **kwargs
    ) -> Dict[str, Any]:
    ...
    def _apply_chromatic_aberration(
        self, image: np.ndarray, object_distance: float, image_distance: float
    ) -> np.ndarray:
    ...
    def _create_checkerboard_pattern(
        self, size: Tuple[int, int], square_size: int = 32
    ) -> np.ndarray:
