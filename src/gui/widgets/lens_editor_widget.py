from PySide6.QtWidgets import QWidget, QHBoxLayout, QScrollArea, QGroupBox, QFormLayout, QLabel, QDoubleSpinBox, QLineEdit, QVBoxLayout, QFrame, QComboBox, QCheckBox
