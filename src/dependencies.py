...
class DependencyManager:
    ...
    def check_dependency(
        self, module_name: str, feature_name: str = None, install_cmd: str = None
    ) -> bool:
        """
...
def check_pil() -> bool:
    ...
    return _dependency_manager.check_dependency(
        "PIL", feature_name="Image loading", install_cmd="pip install Pillow>=8.0.0"
    )
...
def import_optional(
    module_name: str, from_list: Optional[list] = None, fallback: Any = None
) -> Any:
    """
