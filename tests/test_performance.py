...
class TestPerformance(unittest.TestCase):
    ...
    def test_focal_length_calculation_performance(self):
        ...
        self.assertLess(
            elapsed,
            1.0,
            f"10000 focal length calculations took {elapsed:.2f}s (expected <1s)",
        )
    ...
    def test_aberration_calculation_performance(self):
        ...
        self.assertLess(
            elapsed,
            1.0,
            f"100 aberration calculations took {elapsed:.2f}s (expected <1s)",
        )
...
class TestConcurrency(unittest.TestCase):
    ...
    def test_multiple_lenses_independent(self):
        ...
        lenses = [Lens(name=f"Lens_{i}", material="Custom") for i in range(10)]
