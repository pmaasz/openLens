...
class TestDiffraction(unittest.TestCase):
    ...
    def test_airy_pattern(self):
        ...
        r, intensity = self.calc.airy_pattern(
            radius, self.focal_length, self.aperture, num_points=100
        )
    ...
    def test_point_spread_function_2d(self):
        ...
        psf = self.calc.point_spread_function_2d(
            size, self.focal_length, self.aperture, pixels=pixels
        )
...
class TestPolarization(unittest.TestCase):
    ...
    def test_hwp_rotation(self):
        ...
        self.assertAlmostEqual(
            np.abs(rotated.jones_vector[0]), np.abs(rotated.jones_vector[1]), places=3
        )
