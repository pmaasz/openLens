...
class TestPhysicalFeasibility(unittest.TestCase):
    ...
    def test_check_feasible_lens(self):
        ...
        feasible, message = check_physical_feasibility(
            radius1=100.0, radius2=-100.0, thickness=5.0, diameter=20.0
        )
    ...
    def test_check_thick_lens(self):
        ...
        feasible, message = check_physical_feasibility(
            radius1=50.0, radius2=-50.0, thickness=30.0, diameter=20.0  # Very thick
        )
    ...
    def test_check_thin_lens(self):
        ...
        feasible, message = check_physical_feasibility(
            radius1=100.0, radius2=-100.0, thickness=0.5, diameter=50.0  # Very thin
        )
        self.assertFalse(feasible)
        self.assertIsNotNone(message)
